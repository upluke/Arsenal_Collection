// OO Challenge
// http://curric.rithmschool.com/springboard/exercises/js-car-oo-exercise/
...
class Vehicle{
  ...
  let myFirstVehicle2 = new Vehicle("Honda", "Monster Truck", 1999);
  ...
  class Garage{
    ...
    add(v){
      if (this.capacity>this.vehicles.length){
        if (typeof(v)!=='string'){
          this.vehicles.push(v.constructor.name)
