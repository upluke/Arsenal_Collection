...
//     beforeEach(function(){
//         paymentId=0
//         curPayment={billAmt: '4', tipAmt: '2', tipPercent: 50}
//     })
//     it("should submit info", function(){
//         submitPaymentInfo()
//         expect(paymentId).toEqual(1)
//     })

//     it("create currrent payment", function(){
//         expect(createCurPayment()).toBeInstanceOf(Object)
//     })

//     it("append payment table", function(){
//         appendPaymentTable(curPayment)
//         expect(paymentTbody.childElementCount).toEqual(1)
//     })

//     if("should update summary", function(){
//         updateSummary()
//         expect(summaryTds.innerHTML).toContain('%')
//     })
